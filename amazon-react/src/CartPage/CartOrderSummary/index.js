...
const CartOrderSummary = () => {
  ...
  return (
    <div className="order-details">
      ...
      <div className="items">
        <p className="item">
          Items ({mainContext?.state?.addToCart?.cartItems?.length}):
        </p>
        <p className="rate1">
          <span className="symbol-icon">₹</span>
          {mainContext?.state?.addToCart?.totalCost}.00
        </p>
      </div>
      <div className="items">
      ...
      <div className="items-before-tax">
        ...
        <div className="before-tax">
          <span className="symbol-icon">₹</span>
          {mainContext?.state.addToCart.totalCost + shippingCharge}.00
        </div>
      </div>
      <div className="items-tax">
        ...
        <p className="item-tax-percentage">
          <span className="symbol-icon">₹</span>
          {(
            (mainContext?.state.addToCart.totalCost + shippingCharge) *
            0.05
          ).toFixed(2) || 0}
        </p>
      </div>
      ...
      <div className="order-container">
        <button
          ...
          onClick={(e) => handleNavigate(navigate, "checkout", e)}
        >
          Place Your Order
        </button>
      </div>
